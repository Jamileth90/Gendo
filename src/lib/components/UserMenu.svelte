<script lang="ts">
	 ...
	 * Si no hay usuario: muestra "Entrar" y abre JoinModal.
	 * Si hay usuario: muestra avatar con dropdown (Mi perfil, Cerrar sesión).
	 */
			...
			<div class="relative">
				...
				{#if open}
					<div
						...
						class="absolute right-0 mt-2 w-48 py-1 bg-gendo-surface border border-white/[0.08] rounded-xl shadow-xl overflow-hidden"
					>
						<a
							href="/profile"
							on:click={() => (open = false)}
